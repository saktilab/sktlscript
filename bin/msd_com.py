...
parser.add_argument('-l', '--latt', type=str, required=True, help='Ukuran rusuk sel satuan.')
parser.add_argument('-s', '--start', type=int, default=0, help='Titik acuan dalam bilangan bulat. Default = 0.')
parser.add_argument('-g', '--groups', type=str, required=True, help='Molekul didefinisikan dengan Nama*JumlahAtom*JumlahMolekul. Contoh NAP*1*2:DMF*1*20.')
