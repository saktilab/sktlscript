...
os.system("awk '{print $1}' ala | sed 's/[()@=-]//g'> b")
os.system("molmass `cat b` | grep Average > a")
with open("a", 'r') as f:
	for line in f:
		arr = line.split()
...
def run_prep_box():
    ...
    os.system("~/miniconda3/bin/tleap -f tleap.in")
    ...
    with open('npt.mdp', 'w') as f:
    	print(npt_mdp.format(half_box, half_box), file=f)
    ...
    gmxscript.grompp(f="npt.mdp", c="nvt.gro", p="system_GMX.top", t="nvt.cpt" ,o="npt.tpr",maxwarn=1)
    gmxscript.mdrun(deffnm="npt", v=True)    
    gmxscript.trjconv(f="npt.trr", s="npt.tpr", n="mini.ndx", o="final_system.pdb", b=100)
