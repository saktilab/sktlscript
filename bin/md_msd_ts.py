...
parser = argparse.ArgumentParser(description='Compute MSD Using Einstein Equation')
...
parser.add_argument('-dt', '--timestep', type=float, default=0.5, help='Time Step')
parser.add_argument('-print', '--print', type=float, default=1, help='Print option in DC-DFTB-K')
