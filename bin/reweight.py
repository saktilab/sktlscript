...
parser.add_argument("-kt", type=float, default=0.0018152857271589002, help="kT in the energy units of the FES files (default: %(default)s)") # The default value was taken from kT if energy in the unit of hartree with the temperature of 573.15 K
