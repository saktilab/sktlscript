        ...
        for line in reverse_lines(file):
            ...
            if rcount < 50:
                ...
                if 'Error : multiplicity' in line:
                    ...
                    errormessage='Wrong multiplicity'
                ...
                if 'An error has occured in the CASSCF module' in line:
                    ...
                    errormessage="CASSCF module failed"
                ...
                if 'Error: XYZ File reading requested' in line:
                    ...
                    errormessage="XYZ file error problem"
                if '!!!               Filename:' in line:
                    xyzfileerror="yes";orcacrash="yes";earlycrash="yes"
                    errormessage="XYZ file error problem"
                ...
                if 'This wavefunction IS NOT CONVERGED!' in line:
                    ...
                    errormessage="SCF did not converge"
...
# LONG PRINTING MODE
        ...
        if runcomplete=="yes":
            ...
            print("Error message:")
            print(bcolors.FAIL+errormessage)
            #print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++")
